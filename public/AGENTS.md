...
- This repository builds a static Vite and React app.
...
- When documenting MCP, API, SDK, CLI, OAuth, webhooks, or streaming support, distinguish live capabilities from unavailable capabilities.
