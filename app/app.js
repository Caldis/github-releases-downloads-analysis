...
class App extends React.Component {
    ...
    render() {
        const { showInput, showAnalysis, url, user, repo, data, since, totalDownload, trendTag, trendData, distData } = this.state
        return (
                ...
                <QueueAnim className={style.bannerContainer} type="bottom" duration={[350, 0]}>
                    {
                        !showInput ?
                            <div className={style.introContainer} key={1}>
                                ...
                                <div>
                                    <Button raised color="primary" onClick={() => this.setState({ showInput: true })}>
                                        Start
                                    </Button>
                                </div>
                            </div> :
                            <div className={style.input} key={2}>
                                ...
                                <p>Then</p>
                                <Button raised color="primary" onClick={this.handleGetUserInput}>
                                    Analysis
                                </Button>
                            </div>
                    }
